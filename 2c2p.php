...
function fun2c2p_init() {
	...
	class WC_Gateway_2c2p_Hbl extends WC_Payment_Gateway {
		...
		public function __construct() {
			...
			$payment_brands_img_description .= '<div  style="height: 50px">';
			$payment_brands_img_description .= '<img src="' . $hbl_img . ' " alt="hbl" style="height: 30px;margin: 10px auto 10px auto; float:none;  max-height: 30px;" >';
			$payment_brands_img_description .= '</div>';
			...
			add_action( 'woocommerce_api_wchblgateway', array(
				$this,
				'check_2c2p_response'
			...
			add_action( 'woocommerce_checkout_update_order_meta', array(
				&$this,
				'wc_2c2p_custom_checkout_field_update_order_meta'
			) );
